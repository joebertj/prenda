...
SELECT branch,level FROM users WHERE username='<c:out value="${authenticated}"/>'
</sql:query>
...
<sec:authorize access="isAuthenticated()"> 
	...
	<tr>
    	...
    	<img align="absbottom" border="0" src="<c:out value="${contextPath}"/>/common/img/customer.png" id="fpAnimswapImgFP1" name="fpAnimswapImgFP1" dynamicanimation="fpAnimswapImgFP1" lowsrc="<c:out value="${contextPath}"/>/common/img/customer-mo.png"></a>
    	...
    	<img align="absbottom" border="0" src="<c:out value="${contextPath}"/>/common/img/encoder.png" id="fpAnimswapImgFP2" name="fpAnimswapImgFP2" dynamicanimation="fpAnimswapImgFP2" lowsrc="<c:out value="${contextPath}"/>/common/img/encoder-mo.png"></a>
    	...
    	<img align="absbottom" border="0" src="<c:out value="${contextPath}"/>/common/img/manager.png" id="fpAnimswapImgFP3" name="fpAnimswapImgFP3" dynamicanimation="fpAnimswapImgFP3" lowsrc="<c:out value="${contextPath}"/>/common/img/manager-mo.png"></a>
    	...
    	<img align="absbottom" border="0" src="<c:out value="${contextPath}"/>/common/img/owner.png" id="fpAnimswapImgFP4" name="fpAnimswapImgFP4" dynamicanimation="fpAnimswapImgFP4" lowsrc="<c:out value="${contextPath}"/>/common/img/owner-mo.png"></a>
    	...
    	<img align="absbottom" border="0" src="<c:out value="${contextPath}"/>/common/img/admin.png" id="fpAnimswapImgFP5" name="fpAnimswapImgFP5" dynamicanimation="fpAnimswapImgFP5" lowsrc="<c:out value="${contextPath}"/>/common/img/admin-mo.png"></a>
	<sec:authorize access="isAuthenticated()"> 
		<img align="absbottom" border="0" src="<c:out value="${contextPath}"/>/common/img/welcome_back.png"><c:out value="${authenticated}"/><sec:authentication property="principal.authorities"/>
    	...
    	<img align="absbottom" border="0" src="<c:out value="${contextPath}"/>/common/img/logout.png" id="fpAnimswapImgFP6" name="fpAnimswapImgFP6" dynamicanimation="fpAnimswapImgFP6" lowsrc="<c:out value="${contextPath}"/>/common/img/logout-mo.png"></a>
   	</sec:authorize>
		</td>
  	</tr>
</table>