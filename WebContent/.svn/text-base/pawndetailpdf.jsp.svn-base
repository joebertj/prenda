...
WHERE pawn.pid=<c:out value="${param.pid}"/>
			...
			<TABLE border="1">
				...
				<TR>
					...
					<input type="hidden" id="appamt" value='<c:out value="${pawn.rows[0].appraised}" />'/>
					</TD>
				...
				<TR>
					...
					<input type="hidden" id="loanamt" value='<c:out value="${pawn.rows[0].loan}" />'/>
					</TD>
				...
				<TR>
					...
					<form method="post" action="pawnticket.pdf">
						...
						<input type="hidden" name="address" value='<c:out value="${pawn.rows[0].address}"/>'/>
						<input type="hidden" name="appraised" value='<c:out value="${pawn.rows[0].appraised}"/>'/>
						<input type="hidden" name="loan" value='<c:out value="${pawn.rows[0].loan}"/>'/>
						...
						<input type="hidden" name="net" value='<c:out value="${pawn.rows[0].loan}"/>'/>
						<input type="hidden" name="description" value='<c:out value="${pawn.rows[0].description}"/>'/>
