...
import com.prenda.model.obj.iface.IGenkey;
...
/** 
 * Object mapping for hibernate-handled table: genkey.
 * @author autogenerated
 */

@Entity
@Table(name = "genkey", catalog = "prenda")
public class Genkey implements Cloneable, Serializable, IPojoGenEntity, IGenkey {
	 ...
	 */
	public Genkey(Long id, String password) {
    ...
    */
    @Override
    public Genkey clone() throws CloneNotSupportedException {
		
        final Genkey copy = (Genkey)super.clone();
