...
Redeemed Items<br/>
<a href="${contextPath}/owner/redeemsummarystat.jsp">loan value</a> | <a href="${contextPath}/RedeemStatistics.htm?branchid=<c:out value='${user.branchId}'/>&userid=<c:out value='${user.userId}'/>&referer=owner">Rate</a><br/>
Pulled-out Items<br/>
